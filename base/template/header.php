...
<head>
	...
	<title><?php echo isset($pageTitle) ? $pageTitle : 'ACP :: Quản lý hóa đơn'; ?></title>
	<meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1.0,minimum-scale=1.0, minimal-ui" />
	<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo TEMPLATEURL;?>style.css" />
</head>
...
if (Auth::isLogged()){
	...
	<div id="header">
		...
		<form action="" method="get" id="top-search">
			<input type="text" name="keyword" value="" placeholder="Nhập vào từ khóa" />
			<button type="submit">Tìm</button>
		</form>
		<h2><?php echo isset($pageTitle) ? trim(str_replace('ACP :: ','',$pageTitle)) : 'Quản lý hoá đơn'; ?></h2>
	</div>
	<?php
}
?>
